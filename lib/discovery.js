...
// Used in two places:
//   1. As info.x-logo in the OpenAPI spec — picked up by crawlers that
//      honor the ReDoc-style logo convention (e.g. x402scan).
//   2. As the target of /favicon.ico and /favicon.png redirects in
//      index.js — picked up by crawlers that fall back to the standard
//      favicon path when no openapi hint is recognized.
const SFUSE_ICON_URL =
...
const OPENAPI_SPEC = {
  ...
  info: {
    ...
    // ReDoc-style logo convention. x402scan and similar crawlers honor this
    // as an alternative to /favicon.ico for branding the origin in their UI.
    "x-logo": {
      url: SFUSE_ICON_URL,
      altText: "Fuse Network",
    },
  },
...
module.exports = { OPENAPI_SPEC, WELLKNOWN_X402, SFUSE_ICON_URL };
